---
title: "Rozdział V"
description: "Solucja do Gothic II: Odyseja — Rozdział V. Aszdod, Jarkendar i zadania wyzwoleń. Przebieg zadań, wybory i wskazówki."
...
#### Zamknięty pokój {#zamkniety-pokoj}
...
#### Okradnięcie Lorda Andre {#okradniecie-lorda-andre}
...
### Zadania główne i powiązane {#jarkendar-zadania-glowne-i-powiazane}
...
#### Pytania o bogach {#pytania-o-bogach}
...
Amenofis zleca nam zdobycie Szponu Beliara i pokazanie mu go (Misja ["Potężna Broń"](/solucja/rozdzial-iii/#potezna-bron)). Po tym quest się kończy

#### Niebiańska Tarcza {#niebianska-tarcza}

Amenofis zleca nam zdobycie Niebiańskiej Tarczy. Po zrobieniu zadań [Poszukiwania w świątyni Adanosa](/solucja/rozdzial-v/#poszukiwania-w-swiatyni-adanosa) [Biblioteka w kanionie](/solucja/rozdzial-v/#biblioteka-w-kanionie) [Stara piramida](/solucja/rozdzial-v/#stara-piramida) [Ukryta świątynia](/solucja/rozdzial-v/#ukryta-swiatynia).
...
#### Poszukiwania w świątyni Adanosa {#poszukiwania-w-swiatyni-adanosa}
...
Zadanie to jest dostępne dopiero przy misji [Poszukiwania w świątyni Adanosa](/solucja/rozdzial-v/#poszukiwania-w-swiatyni-adanosa)\
...
#### Świątynia Adanosa {#swiatynia-adanosa}
...
#### Biblioteka w kanionie {#biblioteka-w-kanionie}
...
#### Pojedynek z goblinem {#pojedynek-z-goblinem}
...
#### Przyjacielska przysługa {#przyjacielska-przysluga}
...
Almansor nie będzie chciał z nami rozmawiać, więc udajemy się do jego sługi Alvaresa, który zleca nam zdobycie uznania miejscowych. Robimy misje [Myśliwi w Aszdodzie](/solucja/rozdzial-v/#mysliwi-w-aszdodzie), [Kradzież w Aszdodzie](/solucja/rozdzial-v/#kradziez-w-aszdodzie), [Arena w Aszdodzie](/solucja/rozdzial-v/#arena-w-aszdodzie) oraz [Tangrok i Krushok](/solucja/rozdzial-v/#tangrok-i-krushok), po czym zgadza się on na rozmowę z czarnym magiem.

#### Zaginiona lustrzana tarcza {#zaginiona-lustrzana-tarcza}
...
#### Kradzież w Aszdodzie {#kradziez-w-aszdodzie}
...
#### Tangrok i Krushok {#tangrok-i-krushok}
...
#### Arena w Aszdodzie {#arena-w-aszdodzie}
...
#### Składniki dla Alvareza {#skladniki-dla-alvareza}
...
#### Interesy w Aszdodzie {#interesy-w-aszdodzie}
...
#### Głodne pełzacze {#glodne-pelzacze}
...
Po otrzymaniu pozwolenia na wejście do Świątyni Aszdodu, musimy wykonać misje dla czarnych magów, co zleca nam Almansor. Idziemy do Tartarona, który odsyła nas do Almansora w Aszdodzie ([Kości szkieletów](/solucja/rozdzial-v/#kosci-szkieletow)), Charona w Ugarze ([Serca ognistych golemów](/solucja/rozdzial-v/#serca-ognistych-golemow)) oraz Belazara w Armanie ([Upiorne demony](/solucja/rozdzial-v/#upiorne-demony)).

Po rozprawieniu się z zadaniami udajemy się do Amru i robimy dla niego zadanie [Prasmok](/solucja/rozdzial-v/#prasmok). Po tym zadaniu nauczy on nas języka czarnych magów, którego koniecznie się uczymy. Udajemy się teraz do Almansora i kradniemy mu klucz do biblioteki. Przechodzimy przez bibliotekę dostając się do kolejnych pomieszczeń za pomocą przełączników, a quest kończy się po przeczytaniu ostatniej księgi.

#### Kości szkieletów {#kosci-szkieletow}
...
#### Serca ognistych golemów {#serca-ognistych-golemow}
...
Zagadka jest dosyć intuicyjna, w dwóch miejscach należy użyć przemian.
...
## Zadania poboczne i wyzwolenia {#zadania-poboczne-i-wyzwolenia}
...
#### Łowcy głów w Aszdodzie {#lowcy-glow-w-aszdodzie}
...
#### Gra w kości z Broptekiem {#gra-w-kosci-z-broptekiem}
...
#### Ochrona Przełęczy {#ochrona-przeleczy}
...
#### Wyzwolenie Ugaru {#wyzwolenie-ugaru}
...
#### Niewolnicy w Aszdodzie {#niewolnicy-w-aszdodzie}
...
#### Gaudar potrzebuje ludzi {#gaudar-potrzebuje-ludzi}
...
#### Wskazówka Kuternogi {#wskazowka-kuternogi}

Patrz [Złoto Piratów](/solucja/rozdzial-ii/#zloto-piratow)
